...
class PaystackDedicatedAccount(models.Model):
    ...
    dva_account_number = models.CharField(max_length=15, unique=True, null=True, blank=True)
    account_name = models.CharField(max_length=100)
    dva_account_name = models.CharField(max_length=100, null=True, blank=True)
